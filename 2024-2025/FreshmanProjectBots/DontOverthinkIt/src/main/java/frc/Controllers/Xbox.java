...
public class Xbox {
   ...
   * @see Xbox#getLeftY
   */
  public double getLeftX() { return deadBand(controller.getLeftX()); }
   ...
   * @see Xbox#getLeftX
   */
  public double getLeftY() { return deadBand(controller.getLeftY()); }
   ...
   * @see Xbox#getLeftY
   */
  public double getRightX() { return deadBand(controller.getRightX()); }
   ...
   * @see Xbox#getLeftY
   */
  public double getRightY() { return deadBand(controller.getRightY()); }
   ...
   * @see Xbox#getYButton
   */
  public boolean getAButton() { return controller.getAButton(); }
   ...
   * @see Xbox#getYButton
   */
  public boolean getBButton() { return controller.getBButton(); }
   ...
   * @see Xbox#getYButton
   */
  public boolean getXButton() { return controller.getXButton(); }
   ...
   * @see Xbox#getXButton
   */
  public boolean getYButton() { return controller.getYButton(); }
   ...
   */
  public boolean getStartButton() { return controller.getStartButton(); }
   ...
   */
  public boolean getBackButton() { return controller.getBackButton(); }
   ...
   */
  public boolean getLeftBumper() { return controller.getLeftBumper(); }
   ...
   */
  public boolean getRightBumper() { return controller.getRightBumper(); }
   ...
   */
  public boolean isConnected() { return (controller.isConnected()); }
